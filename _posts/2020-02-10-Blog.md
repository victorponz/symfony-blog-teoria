...
El atributo `publishedAt` va a almacenar la fecha actual por lo que hemos de modificar el constructor de la entidad `Post`
...
Y ahora modificamos la plantilla `single_post`
...
Y la **plantilla**, discriminamos si la ruta es `blog` o `blog_buscar` mediante
...
Así que el código queda como [sigue](assets/twig1.txt)

![image-20221017181620516](/symfony-blog-teoria/assets/img/blog/image-20221017181620516.png)
